...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(run_simulation(max_gens, males_per_winner, num_nests, female_mat_time, encounter_delta, metabolism, maturation_rate, mutation_rate, mutation_sd, mass_to_energy, growth_a, growth_b, initial_mass, alpha_mean, alpha_sd, beta_mean, beta_sd, beta_max, verbose, quiet, log_every));
